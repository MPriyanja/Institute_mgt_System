 ...
 * @author tharindu_m
 */
public class AttendenaceReport extends javax.swing.JFrame {

    /**
     * Creates new form AttendenaceReport
     */
    public AttendenaceReport() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        a.put("toDate", toDatee[0]);
        a.put("toMonth", toDatee[1]);
        a.put("toYear", toDatee[2]);
        a.put("fromDate", fromDatee[0]);
        a.put("fromMonth", fromDatee[1]);
        a.put("fromYear", fromDatee[2]);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AttendenaceReport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AttendenaceReport().setVisible(true);
            }
        });
    }
